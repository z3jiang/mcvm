...
typedef std::pair<bool,DataObject*> Expected ;
...
public:
	...
	static DataObject* evalExpression(const Expression* pExpr, Environment* pEnv, Expected e = Expected(false,NULL) );
	...
	static DataObject* evalParamExpr(const ParamExpr* pExpr, Environment* pEnv, size_t nargout, Expected  e = Expected(false,NULL) );

	static DataObject* evalDotExpr(const DotExpr* pExpr, Environment* pEnv, Expected  e = Expected(false,NULL) );
	...
	static DataObject* evalSymbolExpr(const SymbolExpr* pExpr, Environment* pEnv, size_t nargout, Expected  e = Expected(false,NULL) );
	
	// Method to evaluate a symbol in a given environment
	static DataObject* evalSymbol(const SymbolExpr* pExpr, Environment* pEnv ,Expected  e = Expected(false,NULL)  );
