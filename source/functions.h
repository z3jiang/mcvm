...
public:
	...
	Function() { IIRNode::m_type = IIRNode::FUNCTION; DataObject::m_type = DataObject::Type::FUNCTION; }
	virtual ~Function() {}
...
public:
	...
	// Default constructor
	FnHandleObj(Function* pFunction) : m_pFunction(pFunction) { m_type = Type::FN_HANDLE; }
