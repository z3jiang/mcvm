...
MatrixExpr* MatrixExpr::copy() const
{
	...
	return new MatrixExpr(rowCopies);
}	

/***************************************************************
* Function: MatrixExpr::toString()
...
/***************************************************************
* Function: MatrixExpr::getSubExprs()
* Purpose : Access sub-expressions
* Initial : Maxime Chevalier-Boisvert on January 8, 2009
****************************************************************
Revisions and bug fixes:
*/
Expression::ExprVector MatrixExpr::getSubExprs() const
{
...
/***************************************************************
* Function: MatrixExpr::replaceSubExpr()
* Purpose : Replace a sub-expression
* Initial : Maxime Chevalier-Boisvert on March 17, 2008
****************************************************************
Revisions and bug fixes:
*/
void MatrixExpr::replaceSubExpr(size_t index, Expression* pNewExpr)
{
