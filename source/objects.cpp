...
bool DataObject::isMatrixObj() const {
    return ::isMatrixObj(m_type);
}

bool isMatrixObj(DataObject::Type type) { 
    return 
        type == DataObject::Type::MATRIX_I32 ||
        type == DataObject::Type::MATRIX_F64 ||
        type == DataObject::Type::MATRIX_F32 ||
        type == DataObject::Type::MATRIX_C128 ||
        type == DataObject::Type::LOGICALARRAY ||
        type == DataObject::Type::CELLARRAY ||
        type == DataObject::Type::CHARARRAY ||
        type == DataObject::Type::STRUCTARRAY;
}
...
std::string DataObject::getTypeName(Type type)
{
	...
	switch (type)
	{
		// Return the name matching the type
            ...
            case Type::MATRIX_I32		: return "i32 matrix";
            case Type::MATRIX_F32		: return "f32 matrix";
            case Type::MATRIX_F64		: return "f64 matrix";
            case Type::MATRIX_C128	        : return "c128 matrix";
            case Type::LOGICALARRAY	        : return "logical array";
            case Type::CHARARRAY		: return "char array";
            case Type::CELLARRAY		: return "cell array";
            case Type::STRUCTARRAY	        : return "struct array";
            case Type::CLASS_INST		: return "class inst";
            case Type::FUNCTION		        : return "function";
            case Type::RANGE		        : return "range";
            case Type::ARRAY		        : return "array";
            case Type::FN_HANDLE		: return "func handle";
	}
