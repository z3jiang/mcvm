...
template <template <class ScalarType> class ArithOp, class ScalarType> DataObject* lhsScalarArithOp(const DataObject* pMatrixR, ScalarType scalarL)
{
	...
	if (pMatrixR->getType() == DataObject::Type::MATRIX_C128)
	{
	...
	pMatrixR = pMatrixR->convert(DataObject::Type::MATRIX_F64);
...
{
	// If the matrix is a 128-bit complex matrix
	if (pMatrixL->getType() == DataObject::Type::MATRIX_C128)
	{		
		// Get a typed pointer to the matrix
	...
	// Convert the object to 64-bit float matrix
	pMatrixL = pMatrixL->convert(DataObject::Type::MATRIX_F64);
...
template <template <class ScalarType> class CompOp, class ScalarType> DataObject* lhsScalarLogicOp(const DataObject* pMatrixR, ScalarType scalarL)
{
	...
	if (pMatrixR->getType() == DataObject::Type::LOGICALARRAY)
	{
		// Get a typed pointer to the matrix
	...
	else if (pMatrixR->getType() == DataObject::Type::MATRIX_F64)
	{
		// Get a typed pointer to the matrix
		MatrixF64Obj* pMatrix = (MatrixF64Obj*)pMatrixR;
	...
	else if (pMatrixR->getType() == DataObject::Type::CHARARRAY)
	{
		// Get a typed pointer to the matrix
	...
	else if (pMatrixR->getType() == DataObject::Type::MATRIX_C128)
	{		
		// Get a typed pointer to the matrix
		MatrixC128Obj* pMatrix = (MatrixC128Obj*)pMatrixR;
...
{
	// If the object is a logical array
	if (pMatrixL->getType() == DataObject::Type::LOGICALARRAY)
	{
		// Get a typed pointer to the matrix
	...
	// If the object is a floating-point matrix
	else if (pMatrixL->getType() == DataObject::Type::MATRIX_F64)
	{
		// Get a typed pointer to the matrix
		MatrixF64Obj* pMatrix = (MatrixF64Obj*)pMatrixL;
	...
	// If the object is a character array
	else if (pMatrixL->getType() == DataObject::Type::CHARARRAY)
	{
		// Get a typed pointer to the matrix
	...
	// If the object is a complex matrix
	else if (pMatrixL->getType() == DataObject::Type::MATRIX_C128)
	{		
		// Get a typed pointer to the matrix
		MatrixC128Obj* pMatrix = (MatrixC128Obj*)pMatrixL;
...
template <template <class ScalarType> class CompOp> DataObject* matrixLogicOp(const DataObject* pLeftObj, const DataObject* pRightObj)
{
	...
	if (pLeftObj->getType() == DataObject::Type::LOGICALARRAY && pRightObj->getType() == DataObject::Type::LOGICALARRAY)
	{
		// Get typed pointers to the values
	...
	else if (pLeftObj->getType() == DataObject::Type::MATRIX_F64 && pRightObj->getType() == DataObject::Type::MATRIX_F64)
	{
		// Get typed pointers to the values
	...
	else if (pLeftObj->getType() == DataObject::Type::CHARARRAY && pRightObj->getType() == DataObject::Type::CHARARRAY)
	{
		// Get typed pointers to the values
	...
	else if (pLeftObj->getType() == DataObject::Type::MATRIX_C128 || pRightObj->getType() == DataObject::Type::MATRIX_C128)
	{
		// Convert both values to coplex matrices, if necessary
		if (pLeftObj->getType() != DataObject::Type::MATRIX_C128)	 pLeftObj = pLeftObj->convert(DataObject::Type::MATRIX_C128);
		if (pRightObj->getType() != DataObject::Type::MATRIX_C128) pRightObj = pRightObj->convert(DataObject::Type::MATRIX_C128);
	...
	{
		// Convert the objects to 64-bit float matrices, if necessary
		if (pLeftObj->getType() != DataObject::Type::MATRIX_F64) 	pLeftObj = pLeftObj->convert(DataObject::Type::MATRIX_F64);
		if (pRightObj->getType() != DataObject::Type::MATRIX_F64) pRightObj = pRightObj->convert(DataObject::Type::MATRIX_F64);
