...
char Plotting::argIsValid(int argRank){
  ...
  if(argumentList->getObject(argRank)->getType()== DataObject::Type::MATRIX_F64 ){
    
    
    return 'm';
    
    
  }else if( argumentList->getObject(argRank)->getType()== DataObject::Type::CHARARRAY){
