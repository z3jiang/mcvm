...
SymbolExpr* ParamExpr::getSymExpr() const {
  if (m_pExpr->getExprType() == Expression::ExprType::SYMBOL ) {
    return (SymbolExpr*)m_pExpr ;
  }
  std::cout << "Trying to get a non symbolic expr" << std::endl ;
  return (SymbolExpr*)m_pExpr ;
  //return NULL ;
}
/***************************************************************
...
SymbolExpr* ParamExpr::getRootSymbol() {
