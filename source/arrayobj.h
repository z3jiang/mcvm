...
public:
	...
	// Default constructor
	ArrayObj(size_t reserve = 1) { m_type = Type::ARRAY; m_objects.reserve(reserve); }
	
	// Single object constructor
	ArrayObj(DataObject* pObject) : m_objects(1, pObject) { m_type = Type::ARRAY; }
	
	// Double object constructor
	ArrayObj(DataObject* pObj1, DataObject* pObj2)
	{ m_type = Type::ARRAY; m_objects.push_back(pObj1); m_objects.push_back(pObj2); }
