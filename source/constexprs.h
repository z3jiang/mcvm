...
public:
	...
	// Constructor
	IntConstExpr(int64 value) : m_value(value) { 
            m_exprType = Expression::ExprType::INT_CONST; }
...
public:
	...
	// Constructor
	FPConstExpr(float64 value) : m_value(value) { 
            m_exprType = Expression::ExprType::FP_CONST; }
...
public:
	...
	// Constructor
	StrConstExpr(const std::string& value) : m_value(value) { 
            m_exprType = Expression::ExprType::STR_CONST; }
